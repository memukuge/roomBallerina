...
args = sys.argv
if(len(args) < 3):
    print("args: player.py csv beat tempo (measure)")
    sys.exit()
...
try:
    ...
    starthex = int(startmeasure) * int(musicbeat) * 4
except:
    starthex=0

dbgprt("typeofStartHex " + str(type(starthex)))
dbgprt("StartHex " + str(starthex))
